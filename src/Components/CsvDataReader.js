...
class CsvDataReader extends Component {
  ...
  renderColumnNames = (colmunList) => {
    return colmunList.map((item, index) => {
      return (
  ...
  renderCsvDataResults = () => {
    if (
      this.state.csvDataObject &&
      this.state.csvDataObject.resultStatus &&
      this.state.csvDataObject.resultData
    ) {
        ...
        return (
          <div>
            ...
            <span className="text-success">
              Column Names:
              <span className="text-primary">
                <b>{this.renderColumnNames(apiData.columns)}</b>
              </span>
            </span>
            <hr />
            <Card>
